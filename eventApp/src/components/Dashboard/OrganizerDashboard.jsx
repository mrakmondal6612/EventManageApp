...
import { Heart, MessageCircle, Share2, CheckCircle, ChevronDown, MoreHorizontal, XCircle, Camera, BarChart2, UserCheck } from "lucide-react";
...
const OrganizerDashboard = () => {
    ...
    const demoEvents = [
      {
        ...
        description: "Join us for an amazing evening of live music performances from talented student bands and artists. Food and refreshments will be available!",
        thumbnail: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=500&h=300&fit=crop",
        date: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
        time: "18:00",
        location: "Main Campus Ground",
        likes: ["user1", "user2", "user3"],
        comments: [
          { _id: "c1", userId: { firstName: "John", lastName: "Doe" }, text: "Can't wait! 🎵", date: new Date(), photo: "" },
          { _id: "c2", userId: { firstName: "Jane", lastName: "Smith" }, text: "So excited for this!", date: new Date(), photo: "" }
        ]
      },
      {
        _id: "demo2",
        title: "Tech Hackathon 2024",
        description: "48-hour coding competition. Build innovative projects, win amazing prizes, and network with industry professionals. Open to all skill levels!",
        ...
        comments: [
          { _id: "c3", userId: { firstName: "Alex", lastName: "Chen" }, text: "Team registration open?", date: new Date(), photo: "" }
        ]
      },
      {
        _id: "demo3",
        title: "Career Fair Spring 2024",
        description: "Connect with top employers from various industries. Bring your resume and get ready for on-spot interviews and networking opportunities.",
        thumbnail: "https://images.unsplash.com/photo-1544531586-fde5298cdd40?w=500&h=300&fit=crop",
      ...
      },
      {
        ...
        description: "Showcase of stunning artworks and photographs created by our talented students. Opening night reception with refreshments included.",
        thumbnail: "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=500&h=300&fit=crop",
        date: new Date(Date.now() + 21 * 24 * 60 * 60 * 1000).toISOString(),
        time: "16:00",
        location: "Arts Gallery",
        likes: ["user1", "user2", "user3", "user4", "user5"],
        comments: [
          { _id: "c4", userId: { firstName: "Maria", lastName: "Garcia" }, text: "Beautiful collection! 🎨", date: new Date(), photo: "" },
          { _id: "c5", userId: { firstName: "Tom", lastName: "Wilson" }, text: "Will definitely attend", date: new Date(), photo: "" }
        ]
      },
      {
        _id: "demo5",
        title: "Sports Tournament Finals",
        description: "Cheer for your favorite teams in the championship finals! Basketball, volleyball, and soccer tournaments concluding matches.",
        thumbnail: "https://images.unsplash.com/photo-1461896836934- voices-3e26c8e5c2d1?w=500&h=300&fit=crop",
        date: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString(),
        time: "14:00",
        location: "Sports Complex",
        likes: ["user6", "user7", "user8", "user9"],
        comments: [
          { _id: "c6", userId: { firstName: "Chris", lastName: "Lee" }, text: "Go team! 🏆", date: new Date(), photo: "" }
        ]
      },
      {
        _id: "demo6",
        title: "International Food Festival",
        description: "Experience cuisines from around the world prepared by student cultural clubs. Free tastings, cooking demos, and cultural performances!",
        ...
        comments: [
          { _id: "c7", userId: { firstName: "Priya", lastName: "Patel" }, text: "Amazing food! 🍜", date: new Date(), photo: "" },
          { _id: "c8", userId: { firstName: "David", lastName: "Kim" }, text: "Best event ever!", date: new Date(), photo: "" }
        ]
      }
    ];
    setEvents(demoEvents);
    setSuccess("Demo events loaded successfully!");
  ...
  const handleEventUpdate = async (updatedEvent) => {
    const eventId = eventToEdit?._id || updatedEvent.get("_id");
    ...
    try {
      ...
      // Update the event with FormData
  ...
  return (
    <div className="relative min-h-screen bg-gray-50">
      {/* HEADER */}
      <header className="fixed top-0 left-0 right-0 z-20 bg-white/95 backdrop-blur-xl border-b border-purple-100 shadow-sm flex items-center justify-between px-6 py-4">
        <h1 className="text-2xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600">
          AKEvent Dashboard
        </h1>
      ...
      <main className="pt-20 pb-8 px-4 md:px-12">
        <div className="max-w-6xl mx-auto">
          {success && (
            <div className="bg-green-50 border border-green-200 text-green-700 p-3 rounded-lg mb-6 flex items-center">
              <CheckCircle size={20} className="mr-2" /> {success}
            </div>
          )}

          {/* Quick Stats */}
          <div className="bg-white border border-sky-200 p-6 rounded-xl shadow-md mb-6">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex gap-3">
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-indigo-600 py-3 px-6 rounded-lg font-semibold text-white shadow-lg hover:from-purple-700 hover:to-indigo-700 transition-all"
              >
                {showForm ? "Hide Form" : "Create Event"}
              </button>
              {/* <button
                onClick={loadDemoEvents}
                className="bg-gradient-to-r from-green-500 to-teal-500 py-3 px-6 rounded-lg font-semibold text-white shadow-lg hover:from-green-600 hover:to-teal-600 transition-all"
              >
                Load Demo Events
              </button> */}
            </div>
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg ${filter === "all" ? "bg-purple-600 text-white" : "bg-white border border-gray-200 text-gray-200 hover:bg-gray-50"}`}
              >
                All
              </button>
              <button
                onClick={() => setFilter("upcoming")}
                className={`px-4 py-2 rounded-lg ${filter === "upcoming" ? "bg-purple-600 text-white" : "bg-white border border-gray-200 text-gray-200 hover:bg-gray-50"}`}
              >
                Upcoming
              </button>
              <button
                onClick={() => setFilter("past")}
                className={`px-4 py-2 rounded-lg ${filter === "past" ? "bg-purple-600 text-white" : "bg-white border border-gray-200 text-gray-200 hover:bg-gray-50"}`}
              >
                Past
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filteredEvents.map((event) => (
              <div
                key={event._id}
                className="bg-white border border-gray-200 p-5 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 relative"
              >
                <img
                ...
                <div className="absolute top-3 right-3">
                  ...
                  {dropdownOpen === event._id && (
                    <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-200 shadow-xl rounded-lg text-gray-800 z-10">
                      <button
                        onClick={() => handleEditClick(event)}
                        className="block w-full px-4 py-2 hover:bg-gray-200 text-left text-gray-200 transition-all"
                      >
                        Edit
                      </button>
                      <button
                ...
                <div className="mt-4 flex justify-between text-gray-200">
                  ...
                  <div className="flex items-center gap-1 text-gray-600">
                    <UserCheck size={18} /> {event.enrolled?.length || 0}
                  </div>
                  <button
        ...
        {showEditModal && eventToEdit && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
            <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-2xl w-11/12 md:w-2/3 max-h-[80vh] overflow-y-auto relative">
              <button
                onClick={closeModal}
        ...
        {showDeleteModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
            <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-2xl w-11/12 md:w-1/3 text-center">
              ...
              <div className="flex justify-center gap-4">
                <button
                  ...
                  className="bg-red-600 py-2 px-6 rounded-lg text-white hover:bg-red-700 transition-all"
                >
                  Yes, Delete
                </button>
                <button
                  onClick={cancelDelete}
                  className="bg-gray-200 py-2 px-6 rounded-lg text-gray-700 hover:bg-gray-300 transition-all"
                >
                  Cancel
                </button>
              </div>
        ...
        {showProfileModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
            <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-2xl w-11/12 max-w-lg relative">
              ...
              <p className="text-sm text-purple-600 mb-4">Event Organizer</p> {/* Organizer distinction */}
              <div className="space-y-4">
                <input
                  type="text"
                  value={user.firstName || ""}
                  onChange={(e) => setUser({ ...user, firstName: e.target.value })}
                  className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:outline-none transition-all" /* Purple ring for organizer */
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 py-3 rounded-lg font-semibold text-white shadow-lg hover:from-purple-700 hover:to-indigo-700 transition-all"
                >
                  Update Profile
                </button>
              </div>
                    ...
                    <div key={idx} className="space-y-2">
                      <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          {comment.userId && (
                            <p className={`font-semibold ${comment.isOrganizerReply ? "text-purple-600" : "text-purple-600"}`}>
                      ...
                      {!comment.isOrganizerReply && (
                        <div className="flex items-center gap-2 pl-12">
                          <input
                            ...
                            className="flex-1 p-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-800 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:outline-none"
            ...
            <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-2xl w-11/12 max-w-md">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center gap-2 p-3 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-all"
                >
