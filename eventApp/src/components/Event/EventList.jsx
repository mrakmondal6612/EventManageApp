              ...
              <div className="mt-4">
                ...
                <div className="mt-4">
                  ...
                  <button
                    ...
                    className="mt-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-2 px-4 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all"
                  >
                    Post Comment
                  </button>
                </div>
